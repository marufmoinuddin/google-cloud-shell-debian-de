...
clear
echo "You can use novnc server in browser to view your Desktop. 
Just press web preview (on top right) and go to 8080 port and press the vnc.html link. 
Or use the ip and put it to your VNC viewer"
